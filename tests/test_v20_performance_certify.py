...
def test_candidate_selection_rejects_sparse_training_candidates():
    candidates = [
        {"fills": 2, "net_pnl_usd": 0.50, "name": "sparse"},
        {"fills": 20, "net_pnl_usd": 0.20, "name": "viable"},
        {"fills": 35, "net_pnl_usd": 0.10, "name": "more_viable"},
    ]
...
def test_candidate_selection_fails_when_no_training_candidate_is_viable():
    candidates = [
        {"fills": 1, "net_pnl_usd": 0.50, "name": "sparse"},
        {"fills": 5, "net_pnl_usd": 0.20, "name": "still_sparse"},
    ]
